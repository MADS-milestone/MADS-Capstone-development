...
def safe_get(d, keys, default="oof, this data not available"):
    """
...
def extract_from_json(clinical_study):
   ...
   # 1.8. OUTCOMES MODULE
    ...
    extracted_json.update({
        ...
        "Statistical Method": safe_get(results_section, ["outcomeMeasuresModule", "outcomeMeasures", 0, "analyses", 0, "statisticalMethod"]),
    })
...
# for convenience
# hard coded list of: Phase 3, Study Completed, Reported p-values, Sponsor is Pfizer
pfizer_ncts = [
    "NCT00036270",
    "NCT00038467",
    "NCT00065468",
